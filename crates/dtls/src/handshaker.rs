//! **Modified from webrtc-dtls 0.10.0.** Carries
//! `insecure_skip_verify_hello` into the handshake configuration.
...
pub(crate) struct HandshakeConfig {
    ...
    /// See `config::Config::insecure_skip_verify_hello`. **Modified from
    /// webrtc-dtls 0.10.0.**
