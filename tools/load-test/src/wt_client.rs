...
impl crate::transport_probe::Session for WtSession {
...
pub async fn run_probe(
    ...
    let session = WtSession::connect(&format!("https://{server}/"), creds, 3000).await?;
...
pub async fn run_network(
    ...
    let session = WtSession::connect(&format!("https://{server}/"), creds, 5000).await?;
